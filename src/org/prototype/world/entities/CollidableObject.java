...
public class CollidableObject extends WorldObject {
	...
	public CollidableObject(Point position, float newWidth, float newHeight, float xAxisVector, float yAxisVector, float newVelocity) {
	...
	public void updateLocation() {
		float locationY = velocity * yAxisVector;
		this.y += locationY;
